      ...
      <Column className="bg-gray_51 font-gilroy items-center mx-[auto] w-[100%]">
        ...
        <Row className="justify-evenly w-[97%]">
          ...
          <Column className="lg:mt-[24px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[75%]">
            ...
            <Column className="bg-gray_50 items-center justify-end lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] outline outline-[2px] outline-blue_A700 lg:p-[18px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] rounded-radius6 w-[100%]">
              <Img
                src="images/img_download.svg"
                className="lg:h-[32px] xl:h-[37px] 2xl:h-[42px] 3xl:h-[50px] mt-[4px] lg:w-[31px] xl:w-[36px] 2xl:w-[41px] 3xl:w-[49px]"
                alt="download"
              />
              <Text className="font-medium lg:mt-[17px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-bluegray_600 w-[auto]">
                Import Blogs From
              </Text>
              <Img
                src="images/img_wordpresslogo.png"
                className="lg:h-[54px] xl:h-[62px] 2xl:h-[70px] 3xl:h-[83px] lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] lg:w-[53px] xl:w-[61px] 2xl:w-[69px] 3xl:w-[82px]"
                alt="wordpresslogo"
              />
            </Column>
            <Text className="font-semibold lg:mt-[28px] xl:mt-[32px] 2xl:mt-[37px] 3xl:mt-[44px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-bluegray_900 w-[auto]">
              Workflow Automation
            </Text>
            <Text className="font-normal lg:leading-[22px] xl:leading-[25px] 2xl:leading-[29px] 3xl:leading-[34px] lg:mt-[24px] xl:mt-[27px] 2xl:mt-[31px] 3xl:mt-[37px] not-italic lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-bluegray_400 w-[96%]">
              Workflow Automation refers to the design, execution, and
              automation of processes based on workflow rules where human tasks,
              data or files are routed between people or systems based on
              pre-defined business rules. Using enterprise workflow software,
              your business can save time and reduce errors with automation.
            </Text>
            <Button
              className="font-medium 2xl:mt-[104px] 3xl:mt-[124px] lg:mt-[80px] xl:mt-[92px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[48%]"
