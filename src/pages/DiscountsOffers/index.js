    ...
    <>
      <Column className="bg-gray_50 font-gilroy items-center mx-[auto] lg:pb-[32px] xl:pb-[37px] 2xl:pb-[42px] 3xl:pb-[50px] w-[100%]">
        ...
        <Column className="font-chivo items-center lg:mt-[42px] xl:mt-[48px] 2xl:mt-[55px] 3xl:mt-[66px] w-[88%]">
          ...
          <Row className="font-gilroy items-center justify-between lg:mt-[61px] xl:mt-[70px] 2xl:mt-[79px] 3xl:mt-[94px] w-[100%]">
          ...
          <List
            className="font-gilroy lg:gap-[21px] xl:gap-[24px] 2xl:gap-[28px] 3xl:gap-[33px] grid grid-cols-4 min-h-[auto] lg:mt-[30px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] w-[100%]"
