    ...
    <>
      <Column className="bg-gray_51 font-gilroy items-center mx-[auto] w-[100%]">
        ...
        <Row className="justify-evenly w-[97%]">
          ...
          <Column className="lg:mt-[24px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[75%]">
            <Row className="w-[100%]">
              ...
              <Text className="font-semibold lg:ml-[579px] xl:ml-[662px] 2xl:ml-[745px] 3xl:ml-[894px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-gray_902 w-[auto]">
            ...
            <Row className="justify-evenly lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] w-[100%]">
              <Column className="xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-[52%]">
                <Text className="font-semibold lg:leading-[30px] xl:leading-[34px] 2xl:leading-[39px] 3xl:leading-[46px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-bluegray_900 w-[80%]">
                  Battlegrounds Mobile India iOS release date
                </Text>
                <Text className="font-normal lg:leading-[22px] xl:leading-[25px] 2xl:leading-[29px] 3xl:leading-[34px] lg:mt-[26px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[40px] not-italic lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-bluegray_400 w-[88%]">
                  ...
                  based on pre-defined business rules. Using enterprise workflow
              ...
              <Img
                ...
                className="lg:h-[270px] xl:h-[309px] 2xl:h-[348px] 3xl:h-[417px] rounded-radius6 w-[48%]"
                alt="Rectangle1388"
              />
            </Row>
            <Text className="font-semibold lg:mt-[22px] xl:mt-[25px] 2xl:mt-[29px] 3xl:mt-[34px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-black_901 w-[auto]">
              Comments
            </Text>
            <Row className="lg:mt-[16px] xl:mt-[18px] 2xl:mt-[21px] 3xl:mt-[25px] lg:pr-[17px] xl:pr-[20px] 2xl:pr-[23px] 3xl:pr-[27px] w-[100%]">
              <Img
                src="images/img_profileimglarg_46X46.png"
                className="lg:h-[36px] xl:h-[41px] 2xl:h-[47px] 3xl:h-[56px] rounded-radius50 lg:w-[35px] xl:w-[40px] 2xl:w-[46px] 3xl:w-[55px]"
                alt="ProfileImgLarg One"
              />
              <Column className="lg:ml-[12px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] w-[94%]">
                <Text className="font-medium lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-bluegray_900 w-[auto]">
                  <span className="text-colors2 font-gilroy font-semibold">
                    Danial Sams
                  </span>
                  <span className="text-colors2 font-gilroy"> </span>
                  <span className="text-colors3 font-gilroy font-normal not-italic">
                    @Lorme impsum{" "}
                  </span>
                ...
                <Text className="font-medium lg:leading-[17px] xl:leading-[19px] 2xl:leading-[22px] 3xl:leading-[26px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-bluegray_400 w-[100%]">
                  ...
                  elementum diam dictum faucibus.{" "}
                </Text>
                <Row className="items-center lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] pl-[3px] py-[3px] w-[12%]">
                  <Img
                    src="images/img_thumbsup.svg"
                    className="lg:h-[13px] xl:h-[15px] 2xl:h-[17px] 3xl:h-[20px] my-[1px] w-[17%]"
                    alt="thumbsup"
                  />
                  <Text className="font-medium 2xl:ml-[11px] 3xl:ml-[13px] lg:ml-[8px] xl:ml-[9px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-bluegray_400 w-[auto]">
                    30
                  </Text>
                  <Img
                    src="images/img_call.svg"
                    className="lg:h-[13px] xl:h-[15px] 2xl:h-[17px] 3xl:h-[20px] lg:ml-[14px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] my-[1px] w-[17%]"
                    alt="call"
                  />
                  <Text className="flex font-medium items-center 2xl:ml-[11px] 3xl:ml-[13px] lg:ml-[8px] xl:ml-[9px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-bluegray_400 w-[auto]">
                    10
                  </Text>
                </Row>
              </Column>
            </Row>
            <Text className="font-semibold lg:mt-[24px] xl:mt-[27px] 2xl:mt-[31px] 3xl:mt-[37px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-black_901 w-[auto]">
              Comment Settings
            </Text>
            <Row className="justify-between lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[100%]">
              <Text className="font-semibold mt-[3px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-bluegray_900 w-[auto]">
                Allow Comments
              </Text>
              <Switch value={true} className="w-[4%]" />
            </Row>
            <Row className="items-end justify-between lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[100%]">
              <Text className="font-semibold my-[4px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-bluegray_900 w-[auto]">
                Turn Off Spam Comments
              </Text>
              <Switch value={false} className="w-[4%]" />
            </Row>
            ...
            <Button
              className="font-medium lg:mt-[38px] xl:mt-[44px] 2xl:mt-[50px] 3xl:mt-[60px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[48%]"
