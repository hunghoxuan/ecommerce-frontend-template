...
const ZIPCodeSearchPage = () => {
  ...
  return (
    <>
      <Column className="bg-gray_50 font-gilroy items-center mx-[auto] lg:pb-[151px] xl:pb-[173px] 2xl:pb-[195px] 3xl:pb-[234px] w-[100%]">
        ...
        <Row className="lg:mt-[54px] xl:mt-[62px] 2xl:mt-[70px] 3xl:mt-[84px] w-[88%]">
          ...
          <Column className="mt-[4px] pb-[2px] pr-[2px] w-[49%]">
            ...
            <Text className="font-gilroy font-medium lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-black_900 w-[auto]">
              Delivery
            </Text>
            <Text className="font-gilroy font-normal lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] not-italic lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-bluegray_200 w-[auto]">
              Enter Pincode
            </Text>
            <Line className="bg-bluegray_100 h-[1px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] xl:mt-[9px] w-[66%]" />
            <Row className="font-gilroy mb-[1px] ml-[2px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] w-[29%]">
              <Img
                src="images/img_vector_13X11.svg"
                className="lg:h-[11px] xl:h-[12px] 2xl:h-[14px] 3xl:h-[16px] w-[6%]"
                alt="Vector Two"
              />
              <Text className="font-medium 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] mt-[1px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-blue_A700 w-[auto]">
